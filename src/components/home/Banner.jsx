    ...
    <div>
      ...
      <div className="bg-cover bg-center" style={{ backgroundImage: `url(${bghome})` }}>
        ...
        <div className=" md:container h-full mx-auto md:flex ">
          ...
          <div className="w-full md:w-1/2 md:ml-9 flex flex-col md:items-start items-center justify-center text-white relative  md:top-0 top-[480px]">
          ...
          <div className=" mt-40  md:w-1/2 relative md:bottom-0 md:ml-0 ml-3  bottom-[260px]">
            ...
            <div className="facebook-logo bg-white rounded-full p-4 shadow-xl relative left-10 lg:left-[170px] xl:left-[190px] bottom-[320px] md:bottom-[340px] lg:bottom-[380px]">
              <img src={facebook} alt="facebook" className="w-[40px]" />
            </div>

            <div className="snapchat-logo bg-white rounded-full p-4 shadow-xl relative md:left-[330px] lg:left-[120px] xl:left-[180px] bottom-[240px] md:bottom-[270px]">
              <img src={snapchat} alt="snapchat" className="w-[24px]" />
            </div>

            <div className="font-Poppins relative md:left-14 lg:left-16 xl:left-10 bottom-[180px] md:bottom-[240px] lg:bottom-[200px] xl:bottom-[220px] flex w-40 items-center bg-opacity-50 backdrop-blur-lg bg-[rgba(1,1,1,0.1)] rounded-full px-4 py-4">
              <img src={userone} alt="user" className="mr-3" />
              <div className="text-black">Malini Dode</div>
            </div>

            <div className="font-Poppins relative left-[210px] bottom-[280px] md:left-[220px] lg:left-[315px] xl:left-[360px] md:bottom-[320px] lg:bottom-[300px] xl:bottom-[300px] flex w-40 items-center bg-opacity-50 backdrop-blur-lg bg-[rgba(1,1,1,0.1)] rounded-full px-4 py-4">
