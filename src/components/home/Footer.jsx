  ...
  />
    ...
    <footer className="relative font-Montserrat bg-[#f7f7fd] text-black py-4">
        ...
        <div className="grid grid-cols-4 gap-4">
          ...
          {/* Contact Us */}
          <div>
            <p className='font-bold mb-7 mt-4'>Contact Us</p>
          ...
          {/* Quick Links */}
          <div>
            <p className='font-bold text-b mb-7 mt-4'>Quick Links</p>
            <ul>
          ...
          {/* Follow Us */}
          <div>
            <p className='font-bold mb-7 mt-4'>Follow Us</p>
      ...
      <div className="col-span-4 mt-4 text-sm text-gray-500  text-center border-t border-gray-300 pt-4">
            ...
            <p className="float-left">&copy; 2024 Buzzencer. All rights reserved.</p>
